...
MAX_SEQUENCE_LENGTH = 3000 # 每个文档选取3000个词
...
if __name__=='__main__':
    ...
    # rnn_model.save('model/keras_textAll2.model')  # save model
