                ...
                for line in f:
                    ...
                    if countLine==1:
                        ...
                        if len(strs)<3: # total_Return, rank, year, text
                                continue
                        if countLine<10:
                            totreturn=getTotCat(strs[0])
                            sents.append(strs[3]+' '+strs[2]+' '+totreturn+' ')
                        else:
                            sents.append(strs[3])
...
parameters_nb = {'vect__ngram_range': [(1,2),(2,3),(2,4)],'tfidf__use_idf': (True,False),'clf__alpha': (1e-2, 1e-3)}
